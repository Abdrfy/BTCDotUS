...
const questionAnswer3: IFAQQUestionAnswer = {
    questionInfo: { title: 'Can I inscribe my .btc name on Ordinals?', isClosed: true, id: 2 },
    answerInfo: { answerInfo: answer3 }
};

const questionAnswer4: IFAQQUestionAnswer = {
    questionInfo: { title: 'Where does the source code live?', isClosed: true, id: 3 },
    answerInfo: { answerInfo: answer4 }
};

export const generalQuestionAnswersList: IFAQQUestionAnswerList = {
    questionAnswerList: [questionAnswer1, questionAnswer2, questionAnswer3, questionAnswer4]
};
